...
public class HotelOwner {
	...
	public HotelOwner(String ownerName, String ownerEmail, String contactNumber, String username, String password,
			List<Hotel> hotel) {
		super();
	...
	public String toString() {
		return "HotelOwner [ownerId=" + ownerId + ", ownerName=" + ownerName + ", ownerEmail=" + ownerEmail
				+ ", contactNumber=" + contactNumber + ", username=" + username + ", password=" + password + ", hotel="
				+ hotel + "]";
	}
